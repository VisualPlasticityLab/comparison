...
old_fall{1} = '.\suite2p\plane0\Fall.mat';
old_fall{2} = '.\suite2p\plane1\Fall.mat';
old_fall{3} = '.\suite2p\plane2\Fall.mat';
...
%     ops = old.ops;
%     stat = old.stat;
    F_post_chan2 = F_chan2_file{i};
    Fneu_post_chan2 = Fneu_chan2_file{i};
    save(old_fall{i}, 'F_post_chan2', 'Fneu_post_chan2', '-append')   
end